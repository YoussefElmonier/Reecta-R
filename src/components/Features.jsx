    ...
    return (
        <section id="features" className="py-16 md:py-24 px-4 sm:px-6 bg-brand-cream">
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="flex justify-center mb-6 md:mb-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl text-left">
                        {features.map(({ icon: Icon, title, desc, tag }, i) => (
                            <div
                                key={title}
                                className="feature-card reveal flex flex-col gap-6"
                                style={{ transitionDelay: `${i * 0.1}s` }}
                            >
                                <div className="flex justify-between items-start w-full">
                                    <span className="pill bg-brand-orange/10 text-brand-orange">{tag}</span>
                ...
                {/* Language badge */}
                <div className="mt-6 reveal bg-white rounded-[24px] p-6 md:p-8 flex flex-col sm:flex-row items-center sm:items-center gap-4 sm:gap-6 shadow-sm mx-auto max-w-2xl text-left border-none">
